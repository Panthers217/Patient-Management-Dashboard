...
export default function FolderStructure({ isOpen, onClose }) {
  ...
  const GITHUB_USERNAME = "panthers217" // e.g., "octocat"
  const GITHUB_REPO_URL = `https://github.com/${GITHUB_USERNAME}/Patient-Management-Dashboard`
  const PROFILE_IMAGE_URL = `https://github.com/${GITHUB_USERNAME}.png` // GitHub auto-generates this
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-600 mb-2">
                Healthcare Management System • React • Node.js • Prisma
              </p>
              <a
                href={GITHUB_REPO_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white text-sm font-medium rounded-md transition-colors shadow-sm"
              >
